...
import 'package:eshop/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<EshopFirebaseUser> userStream;
  EshopFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = eshopFirebaseUserStream()
